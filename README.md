...
- 
  <img src="assets/images/quraan_feature .png" alt="Players Setup Screen" width="600">
- **Surah Details**: View the text of each Surah in Arabic.

- 
  <img src="assets/images/quraan_showing_feature .png" alt="Players Setup Screen" width="600">
- 
### 2. Hadith Collection
- **Hadith List**: Access a curated list of 50 significant Hadiths.

- 
  <img src="assets/images/hadeth_feature.png" alt="Players Setup Screen" width="600">
- **Hadith Details**: Read the full text of each Hadith in Arabic and English.

- 
  <img src="assets/images/hadeth_showing_feature.png" alt="Players Setup Screen" width="600">

### 3. Digital Sebha
- **Tasbih Counting**: Count your Tasbih digitally with an easy-to-use interface.

- 
  <img src="assets/images/tasbih_feature.png" alt="Players Setup Screen" width="600">
